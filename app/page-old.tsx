...
import { Zap, Plus, Play, Wifi, WifiOff, AlertCircle, CheckCircle, XCircle, Loader2, ChevronDown, ChevronUp, Upload, Database, Trash2 } from 'lucide-react';
...
export default function InferProbeDashboard() {
  ...
  const handleDatasetLoaded = (dataset: DatasetItem[]) => {
    ...
    setScanResults(null); // Clear single scan results
  };
